...
if(isset($_GET['pay'])){
  ...
  $ticketId = rand(235456,635456);
  $date = date("Y-m-d");

  $INSERT = "INSERT INTO tickets VALUES($ticketId, $id, '$department', 'Notvisited', $price, '$name', '$date', '$address', '$email', $numberoftickets)";

  if(mysqli_query($connection, $INSERT)){
     header("location: ../success/index.php?customer=$name&department=$department&numberoftickets=$numberoftickets&date=$date&ticketid=$ticketId&email=$email");
  }
  else{
    echo '
      <script>alert("Something went wrong, please try after some time")</script>
    ';
  }
...
<head>
  <meta charset="UTF-8">
  <title>e-ticketing - Checkout Form</title>
...
<div class="iphone">
  ...
  <form action="#" class="form" method="get">
    ...
    <fieldset>
      <legend>Payment Method</legend>
        ...
        <div class="form__radio">
          ...
          <input id="accountnumber" name="accountnumber" type="number" placeholder="Account number" required/>
        </div>
    ...
    <div>
      ...
      <table>
        <tbody>
          <tr>
            <td>Ticket  fee</td>
            <td align="right">GHc<?php echo $price?></td>
          </tr>
          <tr>
            <td>Discount 0%</td>
            <td align="right">GHc<?php echo 0?></td>
          </tr>
          <tr>
            <td>Price Total</td>
            <td align="right">GHc<?php echo $price?></td>
     ...
     <input type="hidden" name="address" value="<?php echo $address ?>"><input type="hidden" name="email" value="<?php echo $email ?>"><input type="hidden" name="price" value="<?php echo $price ?>">
    ...
    <div>
      <button class="button button--full" type="submit" name="pay"><svg class="icon">
